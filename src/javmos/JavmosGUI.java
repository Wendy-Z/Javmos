...
public final class JavmosGUI {
    ...
    private JPanel createControlPanel() {
        ...
        configureComponent(equationField, CONTROL_PANEL_WIDTH, CONTROL_PANEL_HEIGHT / CONTROL_PANEL_ITEMS, Color.WHITE, 20, drawListener, "", Color.LIGHT_GRAY, new Color(154, 113, 195));
        configureComponent(firstDerivativeLabel, CONTROL_PANEL_WIDTH, CONTROL_PANEL_HEIGHT / CONTROL_PANEL_ITEMS, Color.WHITE, 20, null, "", displayBackgroundColor, new Color(154, 188, 255));
        configureComponent(secondDerivativeLabel, CONTROL_PANEL_WIDTH, CONTROL_PANEL_HEIGHT / CONTROL_PANEL_ITEMS, Color.WHITE, 20, null, "", displayBackgroundColor, new Color(153, 255, 204));
        ...
        configureComponent(domainStepField, CONTROL_PANEL_WIDTH / 3, (CONTROL_PANEL_HEIGHT / CONTROL_PANEL_ITEMS) / 2, Color.WHITE, 20, domainRangeListener, "DOMAIN_STEP", inputBackgroundColor, displayBackgroundColor);
        ...
        configureComponent(rangeStepField, CONTROL_PANEL_WIDTH / 3, (CONTROL_PANEL_HEIGHT / CONTROL_PANEL_ITEMS) / 2, Color.WHITE, 20, domainRangeListener, "RANGE_STEP", inputBackgroundColor, displayBackgroundColor);
    ...
    private void configureComponent(JComponent component, int width, int height, Color border, int fontSize, ActionListener listener, String actionCommand, Color background, Color foreground) {
        ...
        component.setFont(new Font("Calibri Bold", Font.BOLD, fontSize));
